...
\[
  \mathbf{x}_{\mathrm{open}} = \langle D_\triangle;\ T_{\mathrm{net}};\ R_{\mathrm{cat}};\ P_\pm;\ F_\eth;\ K_{\mathrm{mod}};\ G_\aleph;\ \Gamma_\wedge;\ \⊙;\ H_1;\ n{:}m;\ \Omega_0 \rangle.
\]
The proven manifold — the type that a SIC-POVM occupies once its existence is established — encodes as
\[
  \mathbf{x}_{\mathrm{proven}} = \langle D_\odot;\ T_\odot;\ R_\dagger;\ P_\pm^{\mathrm{sym}};\ F_\hbar;\ K_{\mathrm{slow}};\ G_\aleph;\ \Gamma_{\mathrm{broad}};\ \⊙;\ H_\infty;\ n{:}m;\ \Omega_{\mathrm{NA}} \rangle.
\]
