...
% Figure 1 in the Transformation #8 Φ_c anchor subsection (IG.md / QUANTIG)
%
...
\begin{figure}[htbp]
  ...
  \caption{
    ...
    $< 200$ cm$^{-1}$ remain thermally accessible ($K_{\text{turnm}}$).
    %
    ...
    topology ($T_{\text{bullseye}}$) — the all-or-nothing steric selectivity that yields
    provisional degeneracy\_strength $\approx 0.71$ (power-law/low-logarithmic
    boundary) and meets the $\Phi_{\text{ctyogh}}$ candidacy threshold of the Unified
    Imscriptiveon framework (Axiom~5).
  }
