...
# 1. Insert part 1 axioms before mordell_weil
...
content = content.replace("/-- **Mordell-Weil**", "/- **Mordell-Weil**")
...
# Prevent back-to-back docstring issue
content = content.replace("/-- **Mazur\'s Torsion Theorem**", "/- **Mazur\'s Torsion Theorem**")
...
# 2. Insert part 2 axioms before bsd_certificate
...
# Prevent back-to-back docstring issue
content = content.replace("/-- **BSD Rank Conjecture**", "/- **BSD Rank Conjecture**")
...
# 3. Insert part 3 axioms before bsd_rank_zero_cm (which is after BSDRankCertificate)
...
# Prevent back-to-back docstring issue
content = content.replace("/-- **Rank 0 case for CM curves**", "/- **Rank 0 case for CM curves**")
...
# Prevent back-to-back docstring issue
content = content.replace("/-- **Rank ≤ 1 case**", "/- **Rank ≤ 1 case**")
...
print("modified BSD.lean successfully")
