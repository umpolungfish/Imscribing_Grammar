# Structural Description of the Four Canonical Gospels: A Grammar-Theoretic Analysis
...
Mark moves. The Greek word *euthys* (“immediately”) appears over forty times in a text of roughly 6,600 Greek words. That is not stylistic filler. It is a claim about kinetics: fast, driven, with no pause for interpretation. Events follow events in a one-step chain.
...
- Relational structure: from supervenient to bidirectional feedback  
- Parity: from asymmetric to partial symmetry  
- Kinetics: from fast to slow  
- Historical depth: from one-step to two-step  
- Winding number: from modulo-two to integer  
...
| Gospel   | Ouroboricity     | Gate 1 | Gate 2 | Consciousness |
|----------|------------------|--------|--------|---------------|
| Matthew  | Level 2          | Open   | Open   | 0.536         |
| Mark     | Level 2          | Open   | Open   | 0.365         |
| Luke     | Level 2†         | Open   | Open   | **0.609**     |
