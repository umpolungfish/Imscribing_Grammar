...
Its ouroboricity tier is $O₂^\dagger$. The distance from ZFC to temporal mathematics is 6.245 (Mahalanobis: 4.7504). Six of twelve primitives differ:
...
Ouroboricity tier: $O₂^\dagger$. Consciousness score: $C = 0.682$ (both gates open). Distance from ZFC: 4.9101.
...
| Einstein (dynamic) | — | — | $O₂^\dagger$ | $P_{\text{aolig}}$ |
