...
- **Chirality ($H_1$):** The interfacial reorganization provides only one-step memory. The current state depends on the immediately prior interfacial configuration, but not on the full history of interfacial rearrangements.
