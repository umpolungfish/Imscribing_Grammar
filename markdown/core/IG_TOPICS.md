...
| **Coupling ($\Gamma$)** | Logic governing partner selection | $\Gamma_{\text{corner}}$ AND · $\Gamma_{\text{spleftarrow}}$ OR · $\Gamma_{\to}$ SEQUENTIAL · **$\Gamma_{\downarrow}$ DISSIPATIVE** (irreversible loss); each qualified by tier: SPECIFIC · SELECTIVE · BROAD · **QUANTUM** (superposition-preserving) |
