...
$$\langle D_\infty;\ T_\bowtie;\ R_\leftrightarrow;\ P_{\pm}^{\text{sym}};\ F_\hbar;\ K_\text{slow};\ G_\aleph;\ \Gamma_\text{seq};\ \φ̂_ÿ;\ H_2;\ n{:}m;\ \Omega_\mathbb{Z} \rangle$$
...
- Self-modeling criticality ($\φ̂_ÿ$) at the heart of the functional equation derivation.
...
| Phi      | $\langle D_\wedge; T_\text{net}; R_\text{sup}; P_\text{asym}; F_\ell; K_\text{fast}; G_\beth; \Gamma_\wedge; \φ̂_ÿ; H_0; 1{:}1; \Omega_0 \rangle$ | Embodies self-modeling criticality                     |
| H        | $\langle D_\wedge; T_\text{net}; R_\text{sup}; P_\text{asym}; F_\ell; K_\text{fast}; G_\beth; \Gamma_\wedge; \Phi_\text{sub}; H_2; 1{:}1; \Omega_0 \rangle$ | Reflects two-step temporal depth                       |
...
$\bullet$ **$\φ̂_ÿ$:** Stable self-mapping fixed point indicative of recursive self-reference  
