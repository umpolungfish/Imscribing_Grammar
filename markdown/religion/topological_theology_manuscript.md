...
Hell scores zero on consciousness not because God punishes but because the structure of hell has no coordinate for consciousness. The primitives are locked below criticality, kinetics are frozen, and winding is trivial. Hell is structural death — not physical death, but the death of degrees of freedom. A system in hell is a system that has lost every primitive except eternal chirality ($H_\infty$). It continues, but it no longer *becomes*.
