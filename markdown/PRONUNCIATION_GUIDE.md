...
---
# Pronunciation Guide — Imscribing Grammar Phonetic Subscripts

Each of the 49 subscript symbols in the Imscribing Grammar encodes both the
**nature** of its primitive value (through the visual shape of its glyph) and the
**name** of that value (through the sound of its phonetic label). This guide gives
the IPA symbol, an English anchor phrase, and a full articulatory description for
each subscript so that any reader can learn to pronounce the grammar aloud.

Primitive order: D · T · R · P · F · K · G · Γ · Φ · H · S · Ω
