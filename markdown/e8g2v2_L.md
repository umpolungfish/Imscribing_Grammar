...
2. **Why does the $P$ demotion occur?** ~~The Vessel's $\mathbb{Z}_2$ symmetry dissolves into the Aether's quantum superposition. Is this a necessary consequence of maximal unfolding, or is it an artifact of the specific path through $F_4$, $E_6$, $E_7$? If there existed an alternative maximal exceptional structure that preserved $P_{\text{pipevar}}$, the join $G_2 \vee E_8$ would be its structural type. The IG predicts this type; Lie theory does not yet confirm or refute its existence.~~
