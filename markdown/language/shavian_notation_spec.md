...
2. ⬜ Update `primitives.py` ORDINALS dict
3. ⬜ Write migrate_catalog.py script
4. ⬜ Run catalog migration
5. ⬜ Update `Core.lean` notation layer
6. ⬜ Update `Imscription.lean` toString
7. ⬜ Update `Crystal.lean` display output
8. ⬜ Update websites (index.html)
9. ⬜ Update Lean documentation modules
10. ⬜ Update sans_silicon_imscribing practice document
11. ⬜ Verify crystal address bijection still holds
12. ⬜ Verify all distances unchanged
