...
\begin{itemize}
    ...
    \item \texttt{Shor/\allowbreak FullPipeline.\allowbreak lean} (69 lines): n-register Belnap Shor pipeline with exact coherence accounting. Imscription at $O_1$ / $\Phi_{\upsilon}$ (psi parity) --- the $\Phi_\}$ bottleneck (period from B-bias alone) is open.
