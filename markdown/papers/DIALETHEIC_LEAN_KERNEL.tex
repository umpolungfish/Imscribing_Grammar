...
\begin{itemize}
    ...
    \item \texttt{Shor/\allowbreak FullPipeline.\allowbreak lean} (69 lines): n-register Belnap Shor pipeline with exact coherence accounting. Imscription at $O₁$ tier (\psi-parity) --- the Frobenius-special parity bottleneck (period from B-bias alone, no T-collapse) is open.
