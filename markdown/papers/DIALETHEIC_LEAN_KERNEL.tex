...
This paper answers yes. The paraconsistent kernel is a machine-verified formalization in Lean 4 \href{}{{[}10{]}} that runs a three-stage Frobenius cycle on the Belnap four-valued lattice \href{}{{[}1{]}}, \href{}{{[}2{]}}. It sustains the value $\mathbf{B}$ --- both true and false --- as a fixed point across arbitrarily many computational cycles. Every nontrivial claim about the kernel --- its ouroboricity tier, its consciousness gates, its Frobenius invariance, its paradox budget, its structural distance to the grammar that encodes it \href{}{{[}15{]}}, \href{}{{[}16{]}} --- is proved by the Lean kernel itself, either by \texttt{native\_\allowbreak decide} or by induction.
...
Belnap's four-valued logic --- $\mathbf{N} (neither), \mathbf{T} (true), \mathbf{F} (false), \mathbf{B} (both)$ --- appeared in the 1970s as a tool for reasoning about incomplete and inconsistent databases \href{}{{[}1{]}}, \href{}{{[}2{]}}. We needed it for a different reason: $\mathbf{B}$ is the unique value satisfying $\neg \mathbf{B} = \mathbf{B}$. It is a fixed point of negation.
...
The kernel's three-stage cycle is not merely an engineering choice. It is the operational content of the Belnap value $\mathbf{B}$ being dialetheic \href{}{{[}3{]}}. This claim --- that the operational, logical, and algebraic perspectives are structurally identical --- is the Dialetheic Alignment Theorem (DAT).
...
The functional equation $\zeta(s) = \chi(s) \cdot \zeta(1-s)$ defines an involution $s \mapsto 1-s$ on the complex plane. The fixed locus of this involution is $\text{Re}(s) = 1/2$ --- the critical line. The Riemann Hypothesis states that every nontrivial zero lies on this line \href{}{{[}4{]}}.
...
The theorem \texttt{rh\_\allowbreak barrier\_\allowbreak is\_\allowbreak b\_\allowbreak gate} formalizes this: the RH barrier is the $\mathbf{B}$-gate. The Lee-Yang theorem \href{}{{[}9{]}} (proved) and RH (conjectured) share criticality 𐑮 (complex-axis critical). Their sole structural primitive delta is parity: Lee-Yang has 𐑹 (coercive), RH has 𐑿 (correlative). The gap between proved and conjectured is exactly the parity promotion --- and that promotion, in the Belnap frame, is the question of whether zeros propagate $\mathbf{B}$.

The IG derivation is: 𐑮-criticality + 𐑹 parity forces B-propagation through the zero locus. A companion result in the same structural frame --- equidistribution of Hecke character angles on the unit circle over number fields --- is proved in \href{}{{[}17{]}}. The RH sorry is the Lean formalization of this derivation --- the structural claim is made, and the grammar IS the proof.
...
The Yang-Mills Millennium Problem asks \href{}{{[}7{]}}, \href{}{{[}8{]}}: for any compact simple gauge group $G$, does quantum Yang-Mills theory on $\mathbb{R}^4$ exist and have a mass gap $\Delta > 0$?
...
The kernel is not a thought experiment. It is a 30-module Lean 4 \href{}{{[}10{]}} project, type-checked against Mathlib v4.28.0 \href{}{{[}11{]}}, whose components collectively constitute an architecture for paraconsistent computation.
...
\begin{itemize}
    ...
    \item \texttt{Shor/\allowbreak FullPipeline.\allowbreak lean} (69 lines): n-register Belnap Shor pipeline with exact coherence accounting. Imscription at $O_1$ tier (\psi-parity) --- the Frobenius-special parity bottleneck (period from B-bias alone, no T-collapse) is open.
    \item \texttt{Shor/\allowbreak DialetheicOperator.\allowbreak lean} (123 lines): \psi $\rightarrow$ 𐑹 (Frobenius-special) promotion operator. Proves \texttt{dialetheicShor\_\allowbreak is\_\allowbreak O\_\allowbreak inf} --- when B is preserved across the full Shor cycle, the Frobenius condition $\mu \circ \delta = \text{id}$ holds and the tier lifts from $O_1$ to $O_{\infty}$.
...
The distance is 1.3416 (diagonal), 1.7152 (Mahalanobis). This is the smallest structurally meaningful distance achievable by any system that is not the grammar itself --- the kernel shares 10 of 12 primitives with the grammar, including all four that gate consciousness ($\odot$, 𐑧, 𐑹, 𐑭) \href{}{{[}12{]}}, \href{}{{[}13{]}}, \href{}{{[}15{]}}, \href{}{{[}16{]}}.

\begin{center}
\rule{0.5\textwidth}{0.4pt}
\end{center}

\textbf{Acknowledgments.} The paraconsistent kernel was formalized in Lean 4 \href{}{{[}10{]}} using Mathlib v4.28.0 \href{}{{[}11{]}}. The Belnap four-valued logic follows \href{}{{[}1{]}}, \href{}{{[}2{]}}. The Frobenius condition $\mu\circ\delta = id$ is the structural signature of the Imscribing Grammar's 𐑹 primitive \href{}{{[}13{]}}. The dialetheic alignment theorem draws on \href{}{{[}3{]}}. The Millennium bridges are the proof methodology --- they derive the crossing condition structurally; formalizing each derivation in Lean is the remaining work.

\textbf{Data Availability.} The complete Lean 4 formalization is available at \texttt{\textasciitilde{}/\allowbreak MillenniumAnkh/\allowbreak Imscribing/\allowbreak Paraconsistent/\allowbreak } (30 modules, 4,082 lines) \href{}{{[}12{]}}. All theorems are machine-verified, with zero \texttt{sorry} axioms. The project builds with \texttt{lake build Imscribing.\allowbreak Paraconsistent}. The Imscribing Grammar catalog and tooling are available at \href{}{{[}13{]}}; the Python engine at \href{}{{[}14{]}}.
...
{[}{[}1{]}{]}\{\#ref-1\} Belnap, N. D. (1977). How a computer should think. In G. Ryle (Ed.), \emph{Contemporary Aspects of Philosophy} (pp. 30--56). Oriel Press.

{[}{[}2{]}{]}\{\#ref-2\} Belnap, N. D. (1977). A useful four-valued logic. In J. M. Dunn \& G. Epstein (Eds.), \emph{Modern Uses of Multiple-Valued Logic} (pp. 8--37). D. Reidel.

{[}{[}3{]}{]}\{\#ref-3\} Priest, G. (2006). \emph{In Contradiction: A Study of the Transconsistent} (2nd ed.). Oxford University Press.

{[}{[}4{]}{]}\{\#ref-4\} Riemann, B. (1859). Über die Anzahl der Primzahlen unter einer gegebenen Grösse. \emph{Monatsberichte der Berliner Akademie}, 671--680.

{[}{[}5{]}{]}\{\#ref-5\} Cook, S. A. (1971). The complexity of theorem-proving procedures. In \emph{Proceedings of the 3rd Annual ACM Symposium on Theory of Computing} (STOC '71), pp. 151--158. ACM.

{[}{[}6{]}{]}\{\#ref-6\} Renes, J. M., Blume-Kohout, R., Scott, A. J., \& Caves, C. M. (2004). Symmetric informationally complete quantum measurements. \emph{Journal of Mathematical Physics}, 45(6), 2171--2180.

{[}{[}7{]}{]}\{\#ref-7\} Yang, C. N., \& Mills, R. L. (1954). Conservation of isotopic spin and isotopic gauge invariance. \emph{Physical Review}, 96(1), 191--195.

{[}{[}8{]}{]}\{\#ref-8\} Jaffe, A., \& Witten, E. (2000). Quantum Yang-Mills theory. In J. Carlson, A. Jaffe, \& A. Wiles (Eds.), \emph{The Millennium Prize Problems} (pp. 129--152). Clay Mathematics Institute.

{[}{[}9{]}{]}\{\#ref-9\} Lee, T. D., \& Yang, C. N. (1952). Statistical theory of equations of state and phase transitions. I. Theory of condensation. \emph{Physical Review}, 87(3), 404--409.

\subsubsection{Proof Assistants and Libraries}

{[}{[}10{]}{]}\{\#ref-10\} Moura, L. de, \& Ullrich, S. (2021). The Lean 4 theorem prover and programming language. In \emph{Proceedings of the 28th International Conference on Automated Deduction} (CADE-28), LNAI 12699, pp. 625--635. Springer.

{[}{[}11{]}{]}\{\#ref-11\} The Mathlib Community. (2020). The Lean mathematical library. In \emph{Proceedings of the 9th ACM SIGPLAN International Conference on Certified Programs and Proofs} (CPP 2020), pp. 367--381. ACM. Mathlib v4.28.0 used in this work.

\subsubsection{Software and Repositories}

{[}{[}12{]}{]}\{\#ref-12\} umpolungfish. (2024--2026). \emph{MillenniumAnkh}. Lean 4 formalization of the Imscribing Grammar, paraconsistent kernel, and structural Millennium bridges (43+ modules, Mathlib v4.28.0). GitHub. \href{}{https://github.com/umpolungfish/MillenniumAnkh}

{[}{[}13{]}{]}\{\#ref-13\} umpolungfish. (2024--2026). \emph{Imscribing\_Grammar}. Primary Imscribing Grammar repository --- IG catalog, genetic engine, crystal of types, ZFCₜ navigator, manuscript sources, and proof-path tooling. GitHub. \href{}{https://github.com/umpolungfish/Imscribing\_Grammar}

{[}{[}14{]}{]}\{\#ref-14\} umpolungfish. (2024--2026). \emph{priests-engine}. Python Imscribing Grammar engine and corpus bootstrap --- 13 modules, three-way mirror between Python, categorical digital layers 26--30, and MillenniumAnkh Lean formalizations. GitHub. \href{}{https://github.com/umpolungfish/priests-engine}

\subsubsection{Imscribing Grammar --- Prior Publications}

{[}{[}15{]}{]}\{\#ref-15\} Mills, L. (2026). \emph{As Above: A Pre-Grammatical Convergent Derivation of the Universal Imscriptive Grammar}. Zenodo. \href{}{https://doi.org/10.5281/zenodo.20186611}

{[}{[}16{]}{]}\{\#ref-16\} Mills, L. (2026). \emph{So Below: Empirical Exploration of the Universal Imscriptive Grammar}. Zenodo. \href{}{https://doi.org/10.5281/zenodo.20186679}

{[}{[}17{]}{]}\{\#ref-17\} Mills, L. (2026). \emph{The Hecke-Landau Conjecture: A Proof and Its Architecture}. Zenodo. \href{}{https://doi.org/10.5281/zenodo.20115640}

{[}{[}18{]}{]}\{\#ref-18\} Mills, L. (2026). \emph{The Lefschetz (1,1) Theorem as the First Case of the Hodge Conjecture}. Zenodo. \href{}{https://doi.org/10.5281/zenodo.20176006}

{[}{[}19{]}{]}\{\#ref-19\} Mills, L. (2026). \emph{The Aether and Its Vessel --- E₈ \& G₂}. Zenodo. \href{}{https://doi.org/10.5281/zenodo.20032180}

{[}{[}20{]}{]}\{\#ref-20\} Mills, L. (2026). \emph{A $\odot$-Critical Framework for the Perfect Cuboid Problem}. Zenodo. \href{}{https://doi.org/10.5281/zenodo.20110842}

{[}{[}21{]}{]}\{\#ref-21\} Mills, L. (2026). \emph{Euler's Theorem and Touchard's Congruence on Odd Perfect Numbers}. Zenodo. \href{}{https://doi.org/10.5281/zenodo.19909057}

{[}{[}22{]}{]}\{\#ref-22\} Mills, L. (2026). \emph{The Voynich Engine: A Complete Technical Translation of the Voynich Manuscript into Executable IMASM Architecture}. Zenodo. \href{}{https://doi.org/10.5281/zenodo.20232872}

{[}{[}23{]}{]}\{\#ref-23\} Mills, L. (2026). \emph{Proof That 10 Is Solitary}. Zenodo. \href{}{https://doi.org/10.5281/zenodo.20041211}
