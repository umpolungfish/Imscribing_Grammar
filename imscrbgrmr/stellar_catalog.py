...
def _protostar() -> Imscription:
    ...
    𐑷: no topological protection; the system is still assembling.
    """
    return Imscription(
...
def _star_o_star() -> Imscription:
    ...
    ⟨D_∞; T_∈; R_†; P_directional; F_ℏ; K_frtailgamma; G_ℵ; 𐑜(BROAD); 𐑢; 𐑷⟩
    ...
    𐑷: NO topological protection. O-stars are so hot and massive that radiation
    ...
    return Imscription(
        ...
        description=(
            ...
            "𐑷: no topological protection — explosion is the only stable future. "
