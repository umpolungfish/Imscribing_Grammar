...
def register_millennium_imscriptions() -> None:
    ...
    entries: List[Imscription] = [
        ...
        Imscription(
            ...
            kinetic_character=KineticChar.yea,
        ...
        Imscription(
            ...
            criticality_phase=Criticality.monad,
            protection=Protection.ah,
            stoichiometry=Stoichiometry.hung,
            chirality=Chirality.sure,
            description=(
        ...
        Imscription(
            ...
            grammar=Grammar.vow,
            fidelity=Fidelity.peep,
            kinetic_character=KineticChar.loll,
            granularity=Granularity.ice,
            criticality_phase=Criticality.woe,
            protection=Protection.ah,
            stoichiometry=Stoichiometry.hung,
