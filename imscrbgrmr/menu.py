"""
Imscribing Grammar interactive menu — Option A (Rich prompt loop).

Launch with: imscribe menu
"""
...
CATEGORIES = [
    ...
    },
    {
        ...
        "name": "Design",
        "color": "magenta",
        "hint": "pipeline · lift · generate · peel",
        "commands": [
            ...
            ("lift",        "Apply a dimensional/criticality lift",
             [("Imscription", "name"),
              ("Target  (temporal · spatial · critical)", "target")]),
    ...
    },
    {
        ...
        "name": "Catalog",
        "color": "blue",
        "hint": "search · remove · strip · export · audit",
        "commands": [
            ...
            ("ixcription strip",   "Take the name off, leave the address",
             [("Imscription name", "name")]),
            ("ixcription list",    "Addresses standing bare",
             []),
            ("ixcription restore", "Put a stripped name back",
             [("Address", "str")]),
            ("ixcription compare", "Rounds of ixcription over one address",
             [("Address  (blank = all)", "str?")]),
...
def _header() -> None:
    try:
        ...
        _catalog_path = _Path(__file__).resolve().parent.parent / "IG_catalog.json"
