...
`data/IG_catalog.bare.json` is the whole catalog with every form removed, kept with its sidecar so it stays live: point `IG_CATALOG` at it to read it, compare against it, or restore from it.
