...
Each primitive is an irreducible dimension along which any system writes its structural type. The 12 primitives are the vocabulary; the crystal of types is the space of all possible sentences.
...
The 12-primitive space partitions into exactly $17{,}280{,}000 = 3^3 \times 4^5 \times 5^4$ structural types:

- **400 tier cells** determined by $(\Phi, P, \Omega, D)$ — the imscriptive boundary
...
`quiver_crystal.py` implements three generations of quiver-based GNN navigator:
...
*See `MAIN_DOCS/PRIMITIVE_PREDICTIONS.md` for the full prediction archive.*
