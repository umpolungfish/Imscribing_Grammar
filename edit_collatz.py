...
axioms = """/-- Collatz main conjecture axiom.
...
if "theorem lemma1_frobenius_closure" in content:
    content = content.replace("theorem lemma1_frobenius_closure", axioms + "\n" + "theorem lemma1_frobenius_closure")
else:
...
print("cleaned and modified Collatz.lean successfully")
