...
\bigskip
\noindent\textbf{\large 1 -- \emph{Separatio} --- Logical on $\mathcal{C}$.}
...
\bigskip
\noindent\textbf{\large 2 -- \emph{Purificatio} --- Inductive on $\mathcal{C}$.}
\begin{itemize}[nosep, leftmargin=1.5em]
...
\bigskip
\noindent\textbf{\large 3 -- \emph{Albedo} --- Algebraic on $\mathcal{C}$.}
\begin{itemize}[nosep, leftmargin=1.5em]
...
{\large This is the \emph{albedo}: the whitening, the full structuring --- all intermediate forms are now in place.}

\bigskip
\noindent\textbf{\large 4 -- \emph{Rubedo} --- Logical on algebraically-enriched $\mathcal{C}$.}
\begin{itemize}[nosep, leftmargin=1.5em]
