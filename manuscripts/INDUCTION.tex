...
However some, like Luria, knew \emph{precisely} the material upon which the \emph{Work} was to be done.
...
Local ($G_{\text{beta}}$) if the tensor decouples; global ($G_{\text{revapostrophe}}$) if the Yoneda embedding is faithful across all scales.  
...
\textit{Sic transit gloria categori\ae.}
