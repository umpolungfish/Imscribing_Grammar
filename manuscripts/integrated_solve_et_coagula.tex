...
%    AS_ABOVE.tex (pre-grammatical derivation)
...
\newcommand{\PhicC}{\Phi_c^{\mathbb{C}}}
\newcommand{\PhiEP}{\Phi_\text{EP}}
\newcommand{\Phisub}{\Phi_\text{sub}}
\newcommand{\Phisup}{\Phi_\text{sup}}
\newcommand{\Ppms}{P_{\pm}^{\text{sym}}}
\newcommand{\Oinf}{O_\infty}
\newcommand{\Otwo}{O_2}
\newcommand{\OtwoD}{O_2^\dagger}
\newcommand{\Oone}{O_1}
\newcommand{\Ozero}{O_0}
...
\newcommand{\OmegaNA}{\Omega_\text{NA}}
