...
$\langle \text{{\igfont 𐑦}} \text{{\igfont 𐑸}} \text{{\igfont 𐑾}} \Ppms \text{{\igfont 𐑐}} \text{{\igfont 𐑧}} \text{{\igfont 𐑲}} \GamSeq \Phic \text{{\igfont 𐑫}} \text{{\igfont 𐑳}} \OmegaZ \rangle$, tier $\Oinf$. Grammar diagnosis:
