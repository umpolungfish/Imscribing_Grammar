...
\begin{equation}
\text{conjecture floor} = \langle \text{{\igfont 𐑨}} \text{{\igfont 𐑶}} \text{{\igfont 𐑑}} \text{{\igfont 𐑬}} F_\star \text{{\igfont 𐑤}} G_\star \text{{\igfont 𐑝}} \Phic H_\star \text{{\igfont 𐑳}} \text{{\igfont 𐑷}}
\rangle \qquad O₁
