...
self-reference); $\text{{\igprimfont Ħ}} = \text{{\igprimfont Ħ}}_2$ (two-level temporal depth: statement
...
$\text{{\igprimfont Ħ}}_{!}$ (eternal temporal depth): structural coherence is
...
requires step $n - 1$) and reduced temporal depth
...
$H$ &
  ...
  Chirality/temporal depth: $\text{{\igprimfont Ħ}}_0$, $\text{{\igprimfont Ħ}}_1$, $\text{{\igprimfont Ħ}}_2$, $\text{{\igprimfont Ħ}}_{!}$ &
...
\begin{enumerate}
  ...
  \item \textbf{$\text{{\igprimfont Ħ}} = \text{{\igprimfont Ħ}}_2$}: Two-level temporal depth: the statement
    evaluates itself.
