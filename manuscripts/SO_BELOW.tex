...
\Cref{def:tier} is a total function, and the two structural facts stated
...
is a property of every complete structural grammar or of this one. If
...
G\"{o}del sentence $G'$. $\text{{\igprimfont Φ}} = \Ppms$ for the same structural reason as
