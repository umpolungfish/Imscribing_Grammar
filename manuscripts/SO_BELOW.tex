...
\newfontfamily\igfont[Scale=1.1,FakeBold=1.5]{Everson Mono}
...
$\text{{\igprimfont ƒ}}$-ordinal assignments are based on the quantum coherence character
...
\begin{tabular}{@{}llccc@{}}
\toprule
Guest & Binding character & $\text{{\igprimfont ƒ}}$-ordinal & Predicted rank & Experimental rank \\
\midrule
