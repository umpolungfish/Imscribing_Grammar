...
\node[prim=purple,above=0.1cm of s12] (p12) {$\Phi$\\$\Phi_\text{sub}$};
\draw[peel] (s12) -- (base);

% Step 11: Omega
\node[stepno] (s11) at (-6.5,1.8) {11};
\node[prim=green!60!black,above=0.1cm of s11] (p11) {$\Omega$\\$\Omega_0$};
\draw[peel] (s11) -- (s12);
...
\node[prim=green!60!black,above=0.1cm of s8] (p8) {$\Gamma$\\$\Gamma_\text{seq}$};
\draw[peel] (s8) -- (s9);

% Step 7: G
\node[stepno] (s7) at (-0.5,5.4) {7};
\node[prim=orange,above=0.1cm of s7] (p7) {$G$\\$G_\aleph$};
\draw[peel] (s7) -- (s8);

% Step 6: K
\node[stepno] (s6) at (1,6.3) {6};
\node[prim=purple,above=0.1cm of s6] (p6) {$K$\\$K_\text{slow}$};
\draw[peel] (s6) -- (s7);

% Step 5: F
\node[stepno] (s5) at (2.5,7.2) {5};
\node[prim=orange,above=0.1cm of s5] (p5) {$F$\\$F_\hbar$};
\draw[peel] (s5) -- (s6);

% Step 4: R
\node[stepno] (s4) at (4,8.1) {4};
\node[prim=green!60!black,above=0.1cm of s4] (p4) {$R$\\$R_\leftrightarrow$};
\draw[peel] (s4) -- (s5);

% Step 3: T
\node[stepno] (s3) at (5.5,9.0) {3};
\node[prim=purple,above=0.1cm of s3] (p3) {$T$\\$T_\boxtimes$};
\draw[peel] (s3) -- (s4);

% Step 2: D
\node[stepno] (s2) at (7,9.9) {2};
\node[prim=green!60!black,above=0.1cm of s2] (p2) {$D$\\$D_\odot$};
\draw[peel] (s2) -- (s3);

% Step 1: P
\node[stepno] (s1) at (8.5,10.8) {1};
\node[prim=purple,above=0.1cm of s1] (p1) {$P$\\$P_{\pm}^{\text{sym}}$};
\draw[peel] (s1) -- (s2);
