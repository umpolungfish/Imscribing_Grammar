...
from imscrbgrmr.perturbation import PerturbationEngine, PrimitiveJacobian
from imscrbgrmr.provider_config import build_agent_config
...
class Intervention:
    ...
    current_value: str
    suggested_change: str   # e.g. "upgrade ⋈^ð → ⋈^ż"
...
{{
  ...
  "recommendations": [
    {{
      ...
      "suggested_change": "upgrade ⋈^ð → ⋈^ż via electron-withdrawing substituents",
