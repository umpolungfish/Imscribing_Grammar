...
# Unicode chars (⊢,⊣,>,<,⋈,⊤,Γ,ɢ,⊙,Ħ,Σ,Ω) violate API regex ^[a-zA-Z0-9_.-]{1,64}$
...
# `φ̂` is not a primitive. The twelve are ⊢ ⊣ > < ⋈ ⊤ Γ ɢ ⊙ Ħ Σ Ω, and the
...
def _imscribe_system_emit(args: Dict[str, Any]) -> str:
    ...
    # ── Remap legacy Latin/Greek parameter keys (⊢,⊣,>,<,⋈,⊤,Γ,ɢ,⊙,Ħ,Σ,Ω) ──
