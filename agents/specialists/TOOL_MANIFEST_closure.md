...
Full syntax, every flag and subcommand: `file_read` `/home/mrnob0dy666/imsgct/imscribing_grammar/agents/specialists/TOOLS_closure.md`. Read it before using a tool whose invocation you are unsure of.
