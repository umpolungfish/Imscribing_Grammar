...
QUANTUM ADVANTAGE REGIMES — known and actionable:
   A. Topological (Fibonacci anyons): Non-Abelian braiding at 19+ strands gives 11 logical qubits with intrinsic error correction. Advantage threshold: any circuit where braid approximation error ⋈ < 10⁻³ and depth ⊤ exceeds classical MPS simulability (χ > 100).
