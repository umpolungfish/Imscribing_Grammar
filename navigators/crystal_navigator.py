...
# Cell address:  mixed-radix over (⊙, Φ, Ω, Ð) — ordered as BOUNDARY_PRIMS
...
_SHAVIAN_TO_XTAL: dict[str, dict[str, str]] = {
    'Ð': {'Ð_ß':'𐑛', 'Ð_C':'𐑨', 'Ð_;':'𐑼', 'Ð_ω':'𐑦', '𐑛':'𐑛', '𐑨':'𐑨', '𐑼':'𐑼', '𐑦':'𐑦'},
    'Þ': {'Þ_6':'𐑡', 'Þ_K':'𐑰', 'Þ_ò':'𐑥', 'Þ_¨':'𐑶', 'Þ_O':'𐑸', '𐑡':'𐑡', '𐑰':'𐑰', '𐑥':'𐑥', '𐑶':'𐑶', '𐑸':'𐑸'},
    'Ř': {'Ř_¯':'𐑩', 'Ř_ý':'𐑑', 'Ř_Ť':'𐑽', 'Ř_=':'𐑾', '𐑩':'𐑩', '𐑑':'𐑑', '𐑽':'𐑽', '𐑾':'𐑾'},
    'Φ': {'Φ_ɐ':'𐑗', 'Φ_υ':'𐑿', 'Φ_F':'𐑬', 'Φ_˙':'𐑯', 'Φ_}':'𐑹', '𐑗':'𐑗', '𐑿':'𐑿', '𐑬':'𐑬', '𐑯':'𐑯', '𐑹':'𐑹'},
    'ƒ': {'ƒ^ì':'𐑱', 'ƒ^ð':'𐑞', 'ƒ^ż':'𐑐', '𐑱':'𐑱', '𐑞':'𐑞', '𐑐':'𐑐'},
    'Ç': {'Ç^-':'𐑘', 'Ç^W':'𐑤', 'Ç^@':'𐑧', 'Ç^Ù':'𐑪', 'Ç^λ':'𐑺', '𐑘':'𐑘', '𐑤':'𐑤', '𐑧':'𐑧', '𐑪':'𐑪', '𐑺':'𐑺'},
    'Γ': {'Γ_β':'𐑚', 'Γ_γ':'𐑔', 'Γ_ʔ':'𐑲', '𐑚':'𐑚', '𐑔':'𐑔', '𐑲':'𐑲'},
    'ɢ': {'ɢ^∧':'𐑝', 'ɢ^˝':'𐑜', 'ɢ^ˌ':'𐑠', 'ɢ^Ş':'𐑵', '𐑝':'𐑝', '𐑜':'𐑜', '𐑠':'𐑠', '𐑵':'𐑵'},
    '⊙': {'⊙_ž':'𐑢', '⊙_ÿ':'⊙', '⊙_Æ':'𐑮', '⊙_3':'𐑻', '⊙_Ţ':'𐑣', '𐑢':'𐑢', '⊙':'⊙', '𐑮':'𐑮', '𐑻':'𐑻', '𐑣':'𐑣'},
    'Ħ': {'Ħ_Ñ':'𐑓', 'Ħ_£':'𐑒', 'Ħ_A':'𐑖', 'Ħ_!':'𐑫', '𐑓':'𐑓', '𐑒':'𐑒', '𐑖':'𐑖', '𐑫':'𐑫'},
    'Σ': {'Σ_S':'𐑙', 'Σ_ő':'𐑕', 'Σ_ï':'𐑳', '𐑙':'𐑙', '𐑕':'𐑕', '𐑳':'𐑳'},
    'Ω': {'Ω_Å':'𐑷', 'Ω_2':'𐑴', 'Ω_z':'𐑭', 'Ω_5':'𐑟', '𐑷':'𐑷', '𐑴':'𐑴', '𐑭':'𐑭', '𐑟':'𐑟'},
}
...
def imscription_check(boundary: dict, bulk: dict) -> dict:
    ...
    floor_ok  = m == boundary
    tensor_ok = t == bulk
    tier      = compute_tier(boundary["⊙"], boundary["Φ"], boundary["Ω"], boundary["Ð"])
...
class TierCell:
    ...
    def boundary(self) -> dict:
        return {"⊙": self.phi, "Φ": self.p, "Ω": self.omega, "Ð": self.d}
...
class CrystalNavigator:
    ...
    def describe(self) -> None:
        ...
        nav_tier = compute_tier(
            NAVIGATOR_TUPLE["⊙"], NAVIGATOR_TUPLE["Φ"],
    ...
    def tier_of(self, tup: dict) -> str:
        ...
        return compute_tier(tup["⊙"], tup["Φ"], tup["Ω"], tup["Ð"])
