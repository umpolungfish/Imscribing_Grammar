...
H3 is the most... esoteric of our particular coven of conjectures, a statement which will certainly excite half of the readership, and undoubtedly elicit groans from the remainder. We bravely persist. Appleby et al.\ \cite{afmy2017} have verified it computationally in every dimension where a SIC is known. The cohomological reformulation anchors the problem in finite Galois-module terms and makes Tate cohomology directly applicable: $[c]$ is a specific element of the $d$-torsion group $H^2((\bZ/d\bZ)^2, \mu_d)$, and H3 requires the arithmetic pairing to hit exactly that element.
