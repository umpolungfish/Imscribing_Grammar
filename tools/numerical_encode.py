...
PRIM_CARDINALITIES = {'Ð': 4, 'Þ': 5, 'Ř': 4, 'Φ': 5, 'ƒ': 3, 'Ç': 5, 'Γ': 3, 'ɢ': 4, '⊙': 5, 'Ħ': 4, 'Σ': 3, 'Ω': 4}
...
IG_TO_SHAVIAN = {
    'Ð_ω': '𐑦', 'Ð_ß': '𐑼', 'Ð_C': '𐑨', 'Ð_;': '𐑛',
    'Þ_O': '𐑸', 'Þ_K': '𐑰', 'Þ_ò': '𐑥', 'Þ_6': '𐑡', 'Þ_¨': '𐑶',
    'Ř_=': '𐑾', 'Ř_Ť': '𐑩', 'Ř_¯': '𐑑', 'Ř_ý': '𐑽',
    'Φ_}': '𐑹', 'Φ_F': '𐑯', 'Φ_υ': '𐑬', 'Φ_˙': '𐑿', 'Φ_ɐ': '𐑗',
    'ƒ_ż': '𐑐', 'ƒ_ì': '𐑱', 'ƒ_ð': '𐑞',
    'Ç_@': '𐑧', 'Ç_W': '𐑪', 'Ç_-': '𐑺', 'Ç_Ù': '𐑘', 'Ç_λ': '𐑤',
    'Γ_ʔ': '𐑲', 'Γ_γ': '𐑚', 'Γ_β': '𐑔',
    'ɢ_ˌ': '𐑠', 'ɢ_Ş': '𐑜', 'ɢ_^': '𐑝', 'ɢ_˝': '𐑵',
    'φ̂_ÿ': '⊙', 'φ̂_Æ': '𐑮', 'φ̂_3': '𐑻', 'φ̂_ž': '𐑢', 'φ̂_Ţ': '𐑣',
    'Ħ_A': '𐑖', 'Ħ_!': '𐑫', 'Ħ_Ñ': '𐑓', 'Ħ_£': '𐑒',
    'Σ_S': '𐑙', 'Σ_ő': '𐑕', 'Σ_ï': '𐑳',
    'Ω_z': '𐑭', 'Ω_2': '𐑴', 'Ω_Å': '𐑷', 'Ω_5': '𐑟',
}
