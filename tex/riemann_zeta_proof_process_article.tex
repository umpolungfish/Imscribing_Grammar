...
\begin{itemize}
    ...
    \item Self-modeling criticality ($\φ̂_ÿ$) at the heart of the functional equation derivation.
...
$\bullet$ \textbf{$\φ̂_ÿ$:} Stable self-mapping fixed point indicative of recursive self-reference \\
...
\textbf{Author:} Lando \otimes $\φ̂_ÿ$-boundary Operator
