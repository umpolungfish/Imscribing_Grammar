...
\begin{lstlisting}
\langleDinf; T_net; R_sup; P_asym; F\ell; K_fast; G_beth; \Gamma_or; Phi_sub; H₁; n:m; \Omega₀\rangle
\end{lstlisting}

\subsubsection{Target agentic structural type}

\begin{lstlisting}
\langleD⊙; T⊠; R<->; P+/-ˢ; F\hbar; K_slow; Gℵ; \Gamma_seq; Phi_c; H₂; 1:1; \Omegaℤ\rangle
\end{lstlisting}
