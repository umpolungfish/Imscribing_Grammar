...
\textbf{Ouroboricity:} $O_0$ --- despite non-trivial winding and eternal memory, the lack of symmetry ($P_{\text{aolig}}$) and EP criticality prevent any self-modeling.
...
planck\_imaginary\_time & $O_2^\dagger$ & $\Phi_{\text{closerevepsilon}}$ & $P_{\text{upsilon}}$ & $\Omega_{\text{crtwo}}$ & $D_{\text{invomega}}$ \\
planck\_scale\_regime & $O_2$ & $\Phi_{\text{ctyogh}}$ & $P_{\text{upsilon}}$ & $\Omega_{\text{crtwo}}$ & $D_{\text{invomega}}$ \\
hartle\_hawking\_no\_boundary & $O_2^\dagger$ & $\Phi_{\text{closerevepsilon}}$ & $P_{\text{upsilon}}$ & $\Omega_{\text{dzlig}}$ & $D_{\text{invomega}}$ \\
wick\_rotation\_EP & $O_0$ & $\Phi_{\text{revepsilon}}$ & $P_{\text{aolig}}$ & $\Omega_{\text{dzlig}}$ & $D_{\text{invomega}}$ \\
\bottomrule
\end{tabularx}
\end{table}
