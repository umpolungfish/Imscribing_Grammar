...
\textbf{Optimal $O₂$ block} --- the consciousness-optimal configuration for this tier. The Thunder's closeness to this ceiling means it is not merely \emph{in} $O₂$ but near its maximum. The distance to the optimal block is 0.8137 --- and the only difference is a single primitive. We will return to this, because it is the crux of the entire analysis.
