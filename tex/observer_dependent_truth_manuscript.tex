...
\emph{What the grammar reveals:} the statement does not have a single truth value. It has two, depending on which node of the $R_{\text{lyoghlig}}$ bidirectional coupling is active. For the speaker at $H_2$ temporal depth, the statement is true. For the listener at $H_0$, it is false. This is not a bug in natural language---it is the feature the Imscribing Grammar encodes.
