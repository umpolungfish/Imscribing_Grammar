...
IG_TO_SHAVIAN: Dict[str, Dict[str, str]] = {
    ...
    "Ř": {
        "Ř_Ť": "𐑩", "Ř_¯": "𐑑", "Ř_ý": "𐑽", "Ř_=": "𐑾",
        "R_super": "𐑩", "R_cat": "𐑑", "R_dagger": "𐑽", "R_lr": "𐑾",
    },
    "Φ": {
        "Φ_υ": "𐑗", "Φ_F": "𐑿", "Φ_˙": "𐑬", "Φ_}": "𐑯", "Φ_ɐ": "𐑹",
    ...
    "ɢ": {
        "ɢ_Ş": "𐑝", "ɢ_^": "𐑜", "ɢ_˝": "𐑠", "ɢ_ˌ": "𐑵",
        "Gamma_and": "𐑝", "Gamma_or": "𐑜", "Gamma_seq": "𐑠", "Gamma_broad": "𐑵",
    },
    "⊙": {
        "⊙_ž": "𐑢", "⊙_ÿ": "⊙", "⊙_Æ": "𐑮", "⊙_3": "𐑻", "⊙_Ţ": "𐑣",
        "Phi_c": "⊙", "Phi_sub": "𐑢", "Phi_c_complex": "𐑮", "Phi_EP": "𐑻", "Phi_super": "𐑣",
    },
    "Ħ": {
