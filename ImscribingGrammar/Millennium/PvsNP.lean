...
**The meta-barriers** — provable theorems that constrain how P ≠ NP can be proved:
  ...
  **Algebrization** (Aaronson-Wigderson 2009):
  ...
  These three meta-barriers are PROVED THEOREMS — they are *sans* sorry in mathematics.
...
**SynthOmnicon structural note:**
  ...
  on = irreducible complexity threshold. The meta-barriers (relativization, natural proofs)
...
/-- PvsNP is the only MPP with machine-verified meta-barriers.
    ...
    This is the primitive analog of on in SynthOmnicon:
