"""
synthon_tool.py — Imscribing Grammar as an LLM tool
==============================================
...
class IGTool:
    ...
    def generate(description: str,
        ...
        """
        Generate a synthon from a natural-language description via imscribe CLI.
...
IG_TOOL_SCHEMA = {
    ...
    "function": {
        "name": "imscrbgrmr",
        "description": (
            "Verify, probe, and compose synthons using the Imscribing Grammar relational "
