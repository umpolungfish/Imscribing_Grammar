...
PRIMITIVE_MAP = {
    ...
    'Ð_;': ('Ð', ';'),   'Ð_ω': ('Ð', 'ω'),
    # Þ Topology
    'Þ_6': ('Þ', '6'),   'Þ_K': ('Þ', 'K'),   'Þ_ò': ('Þ', 'ò'),
    'Þ_¨': ('Þ', '¨'),   'Þ_O': ('Þ', 'O'),
    # Ř Relational
    'Ř_¯': ('Ř', '̄'),   'Ř_ý': ('Ř', 'ý'),
    'Ř_Ť': ('Ř', 'Ť'),   'Ř_=': ('Ř', '='),
    # Φ Polarity
    'Φ_ɐ': ('Φ', 'ɐ'),   'Φ_υ': ('Φ', 'υ'),   'Φ_F': ('Φ', 'F'),
    'Φ_˙': ('Φ', '̇'),   'Φ_}': ('Φ', '}'),
    # ƒ Fidelity
    'ƒ_ì': ('ƒ', 'ì'),   'ƒ_ð': ('ƒ', 'ð'),   'ƒ_ż': ('ƒ', 'ż'),
    # Ç Kinetics
    'Ç_-': ('Ç', '-'),   'Ç_W': ('Ç', 'W'),   'Ç_@': ('Ç', '@'),
    'Ç_Ù': ('Ç', 'Ù'),   'Ç_λ': ('Ç', 'λ'),
    # Γ Scope
    'Γ_β': ('Γ', 'β'),   'Γ_γ': ('Γ', 'γ'),   'Γ_ʔ': ('Γ', 'ʔ'),
    # ɢ Grammar
    'ɢ_^': ('ɢ', '∧'),   'ɢ_˝': ('ɢ', '˝'),
    'ɢ_ˌ': ('ɢ', 'ˌ'),   'ɢ_Ş': ('ɢ', 'Ş'),
    # ⊙ Criticality
...
OLD_ID_MAP = {
    'D_wedge': 'Ð_ß',    'D_triangle': 'Ð_C',   'D_infty': 'Ð_;',    'D_odot': 'Ð_ω',
    'T_network': 'Þ_6',  'T_in': 'Þ_K',          'T_bowtie': 'Þ_ò',
    'T_boxtimes': 'Þ_¨', 'T_box': 'Þ_¨',         'T_odot': 'Þ_O',
    'R_super': 'Ř_¯',    'R_cat': 'Ř_ý',          'R_dagger': 'Ř_Ť',   'R_lr': 'Ř_=',
    'P_asym': 'Φ_ɐ',     'P_psi': 'Φ_υ',          'P_pm': 'Φ_F',
    'P_sym': 'Φ_˙',      'P_pm_sym': 'Φ_}',
    'F_ell': 'ƒ_ì',      'F_eth': 'ƒ_ð',          'F_hbar': 'ƒ_ż',
    'K_fast': 'Ç_-',     'K_mod': 'Ç_W',          'K_slow': 'Ç_@',
    'K_trap': 'Ç_Ù',     'K_MBL': 'Ç_λ',
    'G_beth': 'Γ_β',     'G_gimel': 'Γ_γ',        'G_aleph': 'Γ_ʔ',
    'G_and': 'ɢ_^',      'Gamma_and': 'ɢ_^',      'G_or': 'ɢ_˝',      'Gamma_or': 'ɢ_˝',
    'G_seq': 'ɢ_ˌ',      'Gamma_seq': 'ɢ_ˌ',      'G_broad': 'ɢ_Ş',   'Gamma_broad': 'ɢ_Ş',
    'Phi_sub': '⊙_ž',    'Phi_c': '⊙_ÿ',          'Phi_c_complex': '⊙_Æ',
    'Phi_EP': '⊙_3',     'Phi_super': '⊙_Ţ',
    'H0': 'Ħ_Ñ',         'H_0': 'Ħ_Ñ',            'H1': 'Ħ_£',        'H_1': 'Ħ_£',
    'H2': 'Ħ_A',         'H_2': 'Ħ_A',            'H_inf': 'Ħ_!',
    'one_one': 'Σ_S',    'S_1_1': 'Σ_S',
    'n_n': 'Σ_ő',        'S_n_n': 'Σ_ő',
    'n_m': 'Σ_ï',        'S_n_m': 'Σ_ï',
