...
def build_universes():
    ...
    rulesets.append(Ruleset(
        name="t_all_dynamics",
        description="T constituted by ALL 5 dynamic primitives (Φ,ƒ,Ç,Ħ,Ω). Canonical gates. "
    ...
    rulesets.append(Ruleset(
        ...
        description="T constituted by ALL 5 structural primitives (Ð,Þ,Ř,Γ,Σ). Canonical gates. "
