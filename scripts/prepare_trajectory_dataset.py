...
T2_IMSCRIBE = TaskTemplate("imscribe_system", "Encode the double pendulum as a type in the Imscribing Grammar.", [
    ...
    {"phase": "OBSERVE", "tool": None,
     "think": "",
     "tool_result": '{"status": "ok", "name": "double_pendulum", "tuple": "⟨𐑨; 𐑥; 𐑾; Φ_±; ƒ_ℓ; Ç_≈; Γ_ℶ; ɢ_→; Φ_↑; Ħ_1; Σ_n:m; Ω_0⟩", "tier": "O₀"}',
     "tool_call": None},
    {"phase": "UPDATE", "tool": None,
    ...
    {"phase": "ACT", "tool": {"name": "done", "arguments": {"conclusion": "The double pendulum imscribes as O₀: ⟨𐑨; 𐑥; 𐑾; Φ_±; ƒ_ℓ; Ç_≈; Γ_ℶ; ɢ_→; Φ_↑; Ħ_1; Σ_n:m; Ω_0⟩. The chaotic dynamics are captured by Φ_↑ (supercritical), the separatrix by 𐑥 (crossing-point topology). No self-modeling gate — this is a structurally typed but externally-described system."}},
...
T3_DISTANCE = TaskTemplate("compute_distance", "What is the distance between a magnetar and a Bose-Einstein condensate?", [
    ...
    {"phase": "OBSERVE", "tool": None,
     "think": "",
     "tool_result": '{"distance": 5.83, "conflicts": [{"primitive": "<", "a": "Φ_±ˢ", "b": "Φ_ψ"}, {"primitive": "⊤", "a": "Ç_↯", "b": "Ç_↺"}, {"primitive": "∈", "a": "Γ_ℵ", "b": "Γ_ℷ"}, {"primitive": "⊙", "a": "⊙_×", "b": "⊙"}, {"primitive": "◻", "a": "Ω_ℤ₂", "b": "Ω_0"}]}',
     "tool_call": None},
    {"phase": "UPDATE", "tool": None,
...
T10_PEEL = TaskTemplate("primitive_peel", "Which primitives are load-bearing for the O_∞ tier? Peel whale_vm and check.", [
    ...
    {"phase": "OBSERVE", "tool": None,
     "think": "",
     "tool_result": '{"original_tier": "O_∞", "peeled_tier": "O₂", "primitive": "<", "dropped_from": "𐑹", "dropped_to": "Φ_∅", "load_bearing": true, "note": "Dropping Φ from Frobenius-special to none collapses O_∞ → O₂. The Frobenius condition μ∘δ=id is essential for terminal operad closure."}',
     "tool_call": None},
    {"phase": "UPDATE", "tool": None,
