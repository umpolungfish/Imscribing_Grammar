...
DESIGNS = [
    ...
    },
    {
        ...
        "description": "Platform therapeutic that self-selects against any disease signature. All-simultaneous detection (∋=∋^∧) — every pathogen feature is processed at once. Many-identical stoichiometry (Σ=𐑕) — all disease patterns share a universal grammar. Eternal memory (Ħ=𐑫) — once a threat is recognized, never forgotten.",
        "⊢": "𐑦", "⊣": "𐑸", ">": "𐑾", "<": "𐑹", "⋈": "𐑐",
        "⊤": "𐑧", "∈": "𐑲", "∋": "∋^∧", "⊙": "⊙", "⊥": "𐑫", "⊞": "𐑕", "◻": "𐑭"
    },
    {
