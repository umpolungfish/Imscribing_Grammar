...
DESIGNS = [
    ...
    },
    {
        ...
        "description": "Epigenetic reprogramming therapeutic that writes persistent chromatin state changes. Supervenience coupling (>=𐑩) — the epigenetic layer supervenes on the genetic substrate. Eternal chirality (⊥=𐑫) ensures reprogramming persists through cell division. Frobenius-closed rewrite edits are idempotent.",
        "⊢": "𐑦", "⊣": "𐑸", ">": "𐑩", "<": "𐑹", "⋈": "𐑐",
        "⊤": "𐑧", "∈": "𐑲", "∋": "∋^∧", "⊙": "⊙", "⊥": "𐑫", "⊞": "𐑳", "◻": "𐑭"
    },
    {
    ...
    },
    {
        ...
        "description": "Structural material that senses damage and self-heals via an internal ouroboric loop. Self-referential topology (⊣=𐑶) — response is a function of its own damage state. Trapped-ordered kinetics (⊤=𐑺) — healing agents stored in ordered activatable reservoir. Eternal damage memory (⊥=𐑫).",
        "⊢": "𐑦", "⊣": "𐑶", ">": "𐑾", "<": "𐑹", "⋈": "𐑐",
        "⊤": "𐑺", "∈": "𐑲", "∋": "∋^∧", "⊙": "⊙", "⊥": "𐑫", "⊞": "𐑳", "◻": "𐑭"
    },
    {
    ...
    },
    {
        ...
        "description": "Smart fabric that weaves all functions — sensing, actuation, communication, energy harvesting — simultaneously. All-simultaneous composition (∋=∋^∧). Moderate kinetics (⊤=𐑤) — responds at human-relevant timescales. Self-written microarchitecture (⊢=𐑦) — each thread contains its own knitting pattern generator.",
        "⊢": "𐑦", "⊣": "𐑸", ">": "𐑾", "<": "𐑹", "⋈": "𐑐",
        "⊤": "𐑤", "∈": "𐑲", "∋": "∋^∧", "⊙": "⊙", "⊥": "𐑫", "⊞": "𐑳", "◻": "𐑭"
    },
    {
        "name": "ouroboric_cell",
        "description": "Synthetic cell whose genome writes and rewrites itself in response to environmental signals. Self-referential topology (⊣=𐑶) — genome encodes its own modification machinery. Frobenius-closed rewrite (<=𐑹) — each edit is a fixed point. Self-written state space (⊢=𐑦). Eternal generational memory (⊥=𐑫).",
        "⊢": "𐑦", "⊣": "𐑶", ">": "𐑾", "<": "𐑹", "⋈": "𐑐",
        "⊤": "𐑧", "∈": "𐑲", "∋": "∋^∧", "⊙": "⊙", "⊥": "𐑫", "⊞": "𐑳", "◻": "𐑭"
    },
    {
        "name": "quantum_bioelectric_tissue",
        "description": "Engineered tissue using quantum-coherent bioelectric fields to guide regeneration. Bidirectional feedback (>=𐑾) — electric field and tissue state mutually determine each other. Quantum coherent ion channels (⋈=𐑐) maintain coherence at tissue scale. Eternal chirality (⊥=𐑫) protects bodyplan blueprint.",
        "⊢": "𐑦", "⊣": "𐑸", ">": "𐑾", "<": "𐑹", "⋈": "𐑐",
        "⊤": "𐑧", "∈": "𐑲", "∋": "∋^∧", "⊙": "⊙", "⊥": "𐑫", "⊞": "𐑳", "◻": "𐑭"
    },
    {
