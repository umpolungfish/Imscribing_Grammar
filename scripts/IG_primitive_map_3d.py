...
ORDINALS = {
    ...
    "∋": {
        ...
        "Γ_xor": 2.5, "Γ_impl": 3.5, "∈_disc": 4.5,
    },
    "⊙": {
...
KEY_imscriptions: dict[str, dict] = {
    "YM classical":          {"⊢":"𐑨","⊣":"𐑡",">":"𐑑","<":"𐑬","⋈":"⋈^ð","⊤":"⊤^W","∈":"𐑚","ɢ":"ɢ^∧","⊙":"𐑢","Ħ":"𐑒","Σ":"one_n","Ω":"𐑭"},
    "YM quantum\n(target)":  {"⊢":"𐑨","⊣":"𐑡",">":"𐑑","<":"𐑬","⋈":"⋈^ż","⊤":"⊤^Ù","∈":"𐑲","ɢ":"ɢ^∧","⊙":"⊙","Ħ":"𐑒","Σ":"one_n","Ω":"𐑭"},
    "RH (ζ zeros)":          {"⊢":"𐑛","⊣":"𐑡",">":"𐑑","<":"𐑯","⋈":"⋈^ż","⊤":"⊤^@","∈":"𐑲","ɢ":"ɢ^∧","⊙":"𐑮","Ħ":"𐑓","Σ":"one_n","Ω":"𐑷"},
    "Lee-Yang\n(proved)":    {"⊢":"𐑛","⊣":"𐑥",">":"𐑑","<":"𐑿","⋈":"⋈^ì","⊤":"⊤^W","∈":"𐑔","ɢ":"ɢ^∧","⊙":"𐑮","Ħ":"𐑒","Σ":"𐑳","Ω":"𐑷"},
    "NS smooth\nsoln":       {"⊢":"𐑨","⊣":"𐑡",">":"𐑽","<":"𐑯","⋈":"⋈^ð","⊤":"⊤^W","∈":"𐑚","ɢ":"ɢ^∧","⊙":"𐑢","Ħ":"𐑓","Σ":"𐑳","Ω":"𐑷"},
    "OPN\nconstraint":       {"⊢":"𐑛","⊣":"𐑰",">":"𐑑","<":"𐑯","⋈":"⋈^ì","⊤":"⊤^Ù","∈":"𐑲","ɢ":"ɢ^∧","⊙":"⊙","Ħ":"𐑓","Σ":"one_n","Ω":"𐑷"},
    "Higgs/axion\n/inflaton": {"⊢":"𐑛","⊣":"𐑥",">":"𐑽","<":"𐑹","⋈":"⋈^ż","⊤":"⊤^@","∈":"𐑚","ɢ":"ɢ^∧","⊙":"⊙","Ħ":"𐑒","Σ":"one_n","Ω":"𐑷"},
    "Standard\nModel":       {"⊢":"𐑨","⊣":"𐑡",">":"𐑽","<":"𐑬","⋈":"⋈^ð","⊤":"⊤^W","∈":"𐑲","ɢ":"ɢ^∧","⊙":"⊙","Ħ":"𐑖","Σ":"𐑳","Ω":"𐑭"},
    "Quantum\nGravity":      {"⊢":"𐑦","⊣":"𐑸",">":"𐑑","<":"𐑯","⋈":"⋈^ż","⊤":"⊤^Ù","∈":"𐑲","ɢ":"Γ_impl","⊙":"⊙","Ħ":"𐑫","Σ":"𐑳","Ω":"𐑟"},
    "General\nRelativity":   {"⊢":"𐑨","⊣":"𐑡",">":"𐑽","<":"𐑯","⋈":"⋈^ż","⊤":"⊤^@","∈":"𐑔","ɢ":"ɢ^∧","⊙":"𐑢","Ħ":"𐑒","Σ":"one_n","Ω":"𐑷"},
    "Asymptotic\nSafety":    {"⊢":"𐑨","⊣":"𐑡",">":"𐑽","<":"𐑯","⋈":"⋈^ż","⊤":"⊤^W","∈":"𐑲","ɢ":"ɢ^∧","⊙":"⊙","Ħ":"𐑒","Σ":"one_n","Ω":"𐑷"},
}
MILLENNIUM = {
...
layout = go.Layout(
    ...
    scene=dict(
        bgcolor="#0F0F1A",
        xaxis=dict(
            title=dict(text="e₁: topological-criticality  Ω vs ∈+⊙", font=dict(color="#888899")),
        ...
        yaxis=dict(
            title=dict(text="e₂: criticality  ⊙ vs ∈+⊢", font=dict(color="#888899")),
            tickfont=dict(color="#888899"),
            gridcolor="#222233",
            zerolinecolor="#333344",
            showbackground=True,
