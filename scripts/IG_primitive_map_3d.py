...
KEY_imscriptions: dict[str, dict] = {
    "YM classical":          {"⊢":"𐑨","⊣":"𐑡","≻":"𐑑","≺":"𐑬","⋈":"⋈^ð","⊤":"⊤^W","∈":"𐑚","∋":"∋^∧","⊙":"𐑢","⊥":"𐑒","⊞":"one_n","◻":"𐑭"},
    "YM quantum\n(target)":  {"⊢":"𐑨","⊣":"𐑡","≻":"𐑑","≺":"𐑬","⋈":"⋈^ż","⊤":"⊤^Ù","∈":"𐑲","∋":"∋^∧","⊙":"⊙","⊥":"𐑒","⊞":"one_n","◻":"𐑭"},
    "RH (ζ zeros)":          {"⊢":"𐑛","⊣":"𐑡","≻":"𐑑","≺":"𐑯","⋈":"⋈^ż","⊤":"⊤^@","∈":"𐑲","∋":"∋^∧","⊙":"𐑮","⊥":"𐑓","⊞":"one_n","◻":"𐑷"},
    "Lee-Yang\n(proved)":    {"⊢":"𐑛","⊣":"𐑥","≻":"𐑑","≺":"𐑿","⋈":"⋈^ì","⊤":"⊤^W","∈":"𐑔","∋":"∋^∧","⊙":"𐑮","⊥":"𐑒","⊞":"𐑳","◻":"𐑷"},
    "NS smooth\nsoln":       {"⊢":"𐑨","⊣":"𐑡","≻":"𐑽","≺":"𐑯","⋈":"⋈^ð","⊤":"⊤^W","∈":"𐑚","∋":"∋^∧","⊙":"𐑢","⊥":"𐑓","⊞":"𐑳","◻":"𐑷"},
    "OPN\nconstraint":       {"⊢":"𐑛","⊣":"𐑰","≻":"𐑑","≺":"𐑯","⋈":"⋈^ì","⊤":"⊤^Ù","∈":"𐑲","∋":"∋^∧","⊙":"⊙","⊥":"𐑓","⊞":"one_n","◻":"𐑷"},
    "Higgs/axion\n/inflaton": {"⊢":"𐑛","⊣":"𐑥","≻":"𐑽","≺":"𐑹","⋈":"⋈^ż","⊤":"⊤^@","∈":"𐑚","∋":"∋^∧","⊙":"⊙","⊥":"𐑒","⊞":"one_n","◻":"𐑷"},
    "Standard\nModel":       {"⊢":"𐑨","⊣":"𐑡","≻":"𐑽","≺":"𐑬","⋈":"⋈^ð","⊤":"⊤^W","∈":"𐑲","∋":"∋^∧","⊙":"⊙","⊥":"𐑖","⊞":"𐑳","◻":"𐑭"},
    "Quantum\nGravity":      {"⊢":"𐑦","⊣":"𐑸","≻":"𐑑","≺":"𐑯","⋈":"⋈^ż","⊤":"⊤^Ù","∈":"𐑲","∋":"𐑠","⊙":"⊙","⊥":"𐑫","⊞":"𐑳","◻":"𐑟"},
    "General\nRelativity":   {"⊢":"𐑨","⊣":"𐑡","≻":"𐑽","≺":"𐑯","⋈":"⋈^ż","⊤":"⊤^@","∈":"𐑔","∋":"∋^∧","⊙":"𐑢","⊥":"𐑒","⊞":"one_n","◻":"𐑷"},
    "Asymptotic\nSafety":    {"⊢":"𐑨","⊣":"𐑡","≻":"𐑽","≺":"𐑯","⋈":"⋈^ż","⊤":"⊤^W","∈":"𐑲","∋":"∋^∧","⊙":"⊙","⊥":"𐑒","⊞":"one_n","◻":"𐑷"},
}
MILLENNIUM = {
...
layout = go.Layout(
    ...
    scene=dict(
        bgcolor="#0F0F1A",
        xaxis=dict(
            title=dict(text="e₁: topological-criticality  ◻ vs ∈+⊙", font=dict(color="#888899")),
