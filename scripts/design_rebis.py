...
# Primitive keys in catalog: ⊢, ⊣, >, <, ⋈, ⊤, ∈, ∋, ⊙, Ħ, Σ, Ω
CAT_KEYS = ['⊢', '⊣', '>', '<', '⋈', '⊤', '∈', '∋', '⊙', '⊥', '⊞', '◻']
...
DESIGNS = [
    ...
    },
    {
        ...
        "description": "Platform therapeutic that self-selects against any disease signature. All-simultaneous detection (∋=∋^∧) — every pathogen feature is processed at once via parallel molecular recognition. Stoichiometry is many-identical (Σ=𐑕) because all disease patterns share a universal grammar. Eternal memory (Ħ=𐑫) means once a threat is recognized, it is never forgotten.",
