...
def _build_preamble(title: str, date: str, abstract: str, keywords: list,
    ...
    lines = [
        ...
        f"{_B}setmainfont{{Linux Libertine O}}",
        f"{_B}setmathfont{{Latin Modern Math}}",
        f"{_B}newfontfamily{_B}igprimfont{{Everson Mono}}",
        ...
        "",
        f"% Section styling — fully unnumbered; pipeline never auto-numbers",
        f"{_B}usepackage{{titlesec}}",
        f"{_B}setcounter{{secnumdepth}}{{0}}",
        f"{_B}titleformat{{{_B}section}}{{{_B}Large{_B}bfseries}}{{}}{{0em}}{{}}",
        f"{_B}titleformat{{{_B}subsection}}{{{_B}large{_B}bfseries}}{{}}{{0em}}{{}}",
        f"{_B}titleformat{{{_B}subsubsection}}{{{_B}normalsize{_B}bfseries}}{{}}{{0em}}{{}}",
        "",
