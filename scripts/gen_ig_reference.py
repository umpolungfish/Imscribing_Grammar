...
def page4() -> str:
    ...
    designs = {
        ...
        "MATERIALS": [
            ("Ouroboric Composite",   "Self-healing CFRP. Embedded capsule network (85\\% efficiency). 7 healing cycles, 90.5\\% fatigue retention at 1000 cycles.", "Ç Þ Φ"),
            ("Topological QM",        "Bi$_2$Se$_3$/FeSe heterostructure. Majorana zero modes, non-Abelian braiding. MajoranaFixed: Majorana $\\equiv$ SIC-POVM $\\equiv$ Belnap B (rfl).", "Þ Ω Ħ"),
        ...
        "BIOLOGY": [
            ...
            ("Topological Morphogenesis","Reaction-diffusion kidney: Wnt/FGF/SDF-1 gradients. Gierer-Meinhardt activator-inhibitor. Tubule network from 500 sim steps.", "Ω Þ Ð"),
        ],
    }
    ...
    magnum_strip = "\n".join([
        ...
        f"  Nigredo & Þ (Topology, collapse) & Citrinitas & ⊙ (Criticality, self-model) \\\\",
