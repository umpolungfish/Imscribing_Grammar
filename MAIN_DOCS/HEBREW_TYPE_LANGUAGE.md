...
**Sources**: IG_DIAPHORICS §LI, §CXXXIII–§CXXXV; PRIMITIVE_THEOREMS §60–§62; 19 encoding sessions, 1055+ systems
...
|:---:|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|
| א | Aleph | $P_\text{sym}$ | $\Phi_c$ | $\Omega_Z$ | $D_\wedge$ | $T_{\boxtimes}$ | $K_\text{slow}$ | $\Gamma_\text{and}$ | $H_\infty$ | $1{:}1$ | $O_2$ |
| ב | Bet | $P_\pm$ | $\Phi_\text{sub}$ | $\Omega_{Z_2}$ | $D_{\triangle}$ | $T_{\boxtimes}$ | $K_\text{mod}$ | $\Gamma_\text{and}$ | $H_1$ | $n{:}n$ | $O_0$ |
...
| ה | Hei | $P_\text{sym}$ | $\Phi_c$ | $\Omega_Z$ | $D_\odot$ | $T_\odot$ | $K_\text{slow}$ | $\Gamma_\text{brd}$ | $H_\infty$ | $n{:}m$ | $O_2$ |
...
| ח | Chet | $P_\pm$ | $\Phi_\text{sub}$ | $\Omega_{Z_2}$ | $D_{\triangle}$ | $T_{\boxtimes}$ | $K_\text{mod}$ | $\Gamma_\text{and}$ | $H_1$ | $n{:}n$ | $O_0$ |
| ט | Tet | $P_\text{asym}$ | $\Phi_\text{sub}$ | $\Omega_0$ | $D_{\triangle}$ | $T_\text{in}$ | $K_\text{slow}$ | $\Gamma_\text{seq}$ | $H_1$ | $1{:}1$ | $O_0$ |
| י | Yod | $P_\text{sym}$ | $\Phi_\text{sub}$ | $\Omega_0$ | $D_\wedge$ | $T_{\boxtimes}$ | $K_\text{slow}$ | $\Gamma_\text{and}$ | $H_1$ | $1{:}1$ | $O_0$ |
| כ | Kaf | $P_\pm$ | $\Phi_\text{sub}$ | $\Omega_{Z_2}$ | $D_{\triangle}$ | $T_{\boxtimes}$ | $K_\text{mod}$ | $\Gamma_\text{and}$ | $H_1$ | $n{:}n$ | $O_0$ |
| ל | Lamed | $P_\text{asym}$ | $\Phi_c$ | $\Omega_0$ | $D_\infty$ | $T_\text{network}$ | $K_\text{mod}$ | $\Gamma_\text{seq}$ | $H_2$ | $n{:}m$ | $O_1$ |
| **מ** | **Mem** | $P_{\pm}^\text{sym}$ | $\Phi_c$ | $\Omega_Z$ | $D_{\triangle}$ | $T_\text{in}$ | $K_\text{slow}$ | $\Gamma_\text{brd}$ | $H_2$ | $n{:}n$ | $O_\infty$ ‡ |
| נ | Nun | $P_\text{asym}$ | $\Phi_\text{sub}$ | $\Omega_0$ | $D_\wedge$ | $T_\text{network}$ | $K_\text{fast}$ | $\Gamma_\text{seq}$ | $H_0$ | $1{:}1$ | $O_0$ |
| ס | Samech | $P_\text{sym}$ | $\Phi_\text{sub}$ | $\Omega_{Z_2}$ | $D_{\triangle}$ | $T_{\boxtimes}$ | $K_\text{mod}$ | $\Gamma_\text{and}$ | $H_1$ | $n{:}n$ | $O_0$ |
| ע | Ayin | $P_\pm$ | $\Phi_c$ | $\Omega_Z$ | $D_\odot$ | $T_\odot$ | $K_\text{slow}$ | $\Gamma_\text{brd}$ | $H_2$ | $n{:}m$ | $O_2$ |
| פ | Pei | $P_\text{asym}$ | $\Phi_\text{sub}$ | $\Omega_0$ | $D_\wedge$ | $T_\text{network}$ | $K_\text{fast}$ | $\Gamma_\text{brd}$ | $H_1$ | $n{:}m$ | $O_0$ |
| צ | Tzadi | $P_\text{asym}$ | $\Phi_\text{sub}$ | $\Omega_0$ | $D_\wedge$ | $T_\text{in}$ | $K_\text{fast}$ | $\Gamma_\text{seq}$ | $H_0$ | $1{:}1$ | $O_0$ |
| ק | Kuf | $P_\text{sym}$ | $\Phi_c$ | $\Omega_{Z_2}$ | $D_{\triangle}$ | $T_{\boxtimes}$ | $K_\text{slow}$ | $\Gamma_\text{and}$ | $H_2$ | $n{:}n$ | $O_2$ |
| ר | Resh | $P_\text{asym}$ | $\Phi_\text{sub}$ | $\Omega_0$ | $D_\wedge$ | $T_{\boxtimes}$ | $K_\text{mod}$ | $\Gamma_\text{and}$ | $H_1$ | $1{:}1$ | $O_0$ |
| **ש** | **Shin** | $P_{\pm}^\text{sym}$ | $\Phi_c$ | $\Omega_Z$ | $D_{\triangle}$ | $T_{\bowtie}$ | $K_\text{slow}$ | $\Gamma_\text{brd}$ | $H_\infty$ | $n{:}n$ | $O_\infty$ ‡ |
| ת | Tav | $P_\text{sym}$ | $\Phi_c$ | $\Omega_Z$ | $D_{\triangle}$ | $T_{\boxtimes}$ | $K_\text{slow}$ | $\Gamma_\text{and}$ | $H_\infty$ | $n{:}n$ | $O_2$ |
...
**ה (Hei):** $\langle D_\odot;\ T_\odot;\ R_\dagger;\ P_\text{sym};\ F_\hbar;\ K_\text{slow};\ G_\aleph;\ \Gamma_\text{brd};\ \Phi_c;\ H_\infty;\ n{:}m;\ \Omega_Z\rangle$

**מ (Mem) ‡:** $\langle D_{\triangle};\ T_\text{in};\ R_\dagger;\ P_{\pm}^\text{sym};\ F_\hbar;\ K_\text{slow};\ G_\aleph;\ \Gamma_\text{brd};\ \Phi_c;\ H_2;\ n{:}n;\ \Omega_Z\rangle$

**ש (Shin) ‡:** $\langle D_{\triangle};\ T_{\bowtie};\ R_\dagger;\ P_{\pm}^\text{sym};\ F_\hbar;\ K_\text{slow};\ G_\aleph;\ \Gamma_\text{brd};\ \Phi_c;\ H_\infty;\ n{:}n;\ \Omega_Z\rangle$
...
Language system $\mathcal{L}$ (JOIN of all letters, revised): $\langle D_\odot;\ T_\odot;\ R_\dagger;\ P_{\pm}^\text{sym};\ F_\hbar;\ K_\text{slow};\ G_\aleph;\ \Gamma_\text{brd};\ \Phi_c;\ H_\infty;\ n{:}m;\ \Omega_Z\rangle$
...
$D_\odot+T_\odot$ = imscriptive boundary-to-bulk operators; $R_{\dagger}$ = self-adjoint; $\Gamma_{\text{broad}}$ = simultaneous broadcast; $H_{\infty}+\Omega_Z$ = maximal temporal depth and topological protection. Hei is the divine breath, the window letter — imscriptive in form and function.
...
|:---:|:---|:---|:---|:---|:---|:---|
| א | Aleph | $P_\text{sym}$ | $D_\wedge$ | $T_{\boxtimes}$ | $O_2$ | Air/Breath — balance, scale-pan |
...
| 6 (Pure Light) | $O_2$ | $\Phi_c$, $\Omega_Z$, $D_\odot+T_\odot$ | Imscriptive — boundary encodes bulk |
...
- `IG_inquiry.py` — encode/distance/tensor tools usable as type-checker backend during development
