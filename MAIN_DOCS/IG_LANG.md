...
| `imscrbgrmr/models.py` | 3d | $T_{\text{braid}}$ · $K_{\text{MBL}}$ · QUANTUM/DISSIPATIVE grammar · TopoIndex |
...
- **2nd order** — HotSwap path exists through $\Phi_c$ intermediates (continuous; `imscribe transition` finds the path and reports forward/reverse costs and $\Phi_c$ intermediates)
